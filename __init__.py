...
from .vts_model_loading import NODE_CLASS_MAPPINGS as VTS_MODEL_LOADING_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as VTS_MODEL_LOADING_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(VTS_MODEL_LOADING_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(VTS_MODEL_LOADING_NODE_DISPLAY_NAME_MAPPINGS)
