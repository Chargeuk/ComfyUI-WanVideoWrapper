...
NODE_CLASS_MAPPINGS = {
    "VTSWanVideoImageResizeToClosest": WanVideoImageResizeToClosest,
    "VTSWanVideoVACEStartToEndFrame": WanVideoVACEStartToEndFrame,
    "VTSExtractStartFramesForContinuations": ExtractStartFramesForContinuations,
    "VTSCreateCFGScheduleFloatList": CreateCFGScheduleFloatList,
    "VTSDummyComfyWanModelObject": DummyComfyWanModelObject,
    "VTSWanVideoLatentReScale": WanVideoLatentReScale,
    "VTSCreateScheduleFloatList": CreateScheduleFloatList,
    "VTSWanVideoSigmaToStep": WanVideoSigmaToStep,
    "VTSNormalizeAudioLoudness": NormalizeAudioLoudness,
    "VTSWanVideoPassImagesFromSamples": WanVideoPassImagesFromSamples,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "VTSWanVideoImageResizeToClosest": "VTS WanVideo Image Resize To Closest",
    "VTSWanVideoVACEStartToEndFrame": "VTS WanVideo VACE Start To End Frame",
    "VTSExtractStartFramesForContinuations": "VTS Extract Start Frames For Continuations",
    "VTSCreateCFGScheduleFloatList": "VTS Create CFG Schedule Float List",
    "VTSDummyComfyWanModelObject": "VTS Dummy Comfy Wan Model Object",
    "VTSWanVideoLatentReScale": "VTS WanVideo Latent ReScale",
    "VTSCreateScheduleFloatList": "VTS Create Schedule Float List",
    "VTSWanVideoSigmaToStep": "VTS WanVideo Sigma To Step",
    "VTSNormalizeAudioLoudness": "VTS Normalize Audio Loudness",
    "VTSWanVideoPassImagesFromSamples": "VTS WanVideo Pass Images From Samples",
}